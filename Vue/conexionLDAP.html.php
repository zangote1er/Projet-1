        ...
        <div class="col-md-4 offset-md-4">
          ...
          <form method="post" action="se connecter.php">
            <div class="form-group mb-3">
              ...
              <input type="text" required autocomplete="off" name="user name" placeholder="Entrez votre username" class="form-control" />
            </div>


            <div class="form-group mb-3">
              <label for="password"> mot de passe </label>
              <input type="text" name="mot de passe" required autocomplete="off" placeholder="Entrez votre mot de passe" class="form-control" />
              <br>
